...
<body class="theme-red">
	...
	<?php 
		...
		$sql=mysqli_query($koneksi,"SELECT * FROM tb_pengguna WHERE id='$user'");
...
<?php 
	...
	// 			window.location.href='/aplikasi_pos/login.php';
	// 		</script>
	// 	";
	// }
 ?>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="page/penjualan/laporan.php" method="POST">
            ...
            <div class="modal-footer">
            	<input type="submit" class="btn btn-primary waves-effect" value="Cetak">
